...
pub struct UserInteractionUtils {}

impl UserInteractionUtils {
    pub fn get_path_and_ratio() -> (String, u32) {
        ...
        if args.interactive {
            ...
            if args.path.is_none() {
                println!("Please provide a path to the image file using the --path argument or run in interactive mode using the --interactive flag.");
                std::process::exit(1);
            }
